...
class DeepHPM_SWIM:
    def __init__(self, t_train, x_train, u_train, t_val, x_val, u_val, u_layers, lb_idn, ub_idn, act_func):
	...
	def grab_ratcoeffs(self):
		return self.ratweightsP, self.ratweightsQ

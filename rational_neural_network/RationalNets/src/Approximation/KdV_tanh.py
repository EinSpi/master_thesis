...
class DeepHPM:
    ...
    def save_loss(self):
        ...
        np.savetxt("Results/tanh/loss_tanh.csv", L, delimiter=',')
        
        # Validation loss
        L = np.vstack((its, self.ValArray)).transpose()
        np.savetxt("Results/tanh/val_tanh.csv", L, delimiter=',')
...
if __name__ == "__main__":
    ...
    if not os.path.exists("Results/tanh"):
        os.makedirs("Results/tanh")
    ...
    np.savetxt("Results/tanh/domain.csv", X_idn_star, delimiter=',')
    np.savetxt("Results/tanh/exact_sol.csv", Exact_idn, delimiter=',')
    ...
    # write mse
    with open("Results/tanh/errors.txt", "w") as f:
    ...
    np.savetxt("Results/tanh/idn_tanh.csv", U_pred, delimiter=',')
    ...
    savefig('Results/tanh/KdV_idn_tanh' )

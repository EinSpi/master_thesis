...
print('### adaptive_Tanh ###')
subprocess.call('python3 KdV_adaptive_tanh.py --init_tanh_a 1.0', shell=True, cwd=cwd)
subprocess.call('python3 KdV_adaptive_tanh.py --init_tanh_a 2.0', shell=True, cwd=cwd)
subprocess.call('python3 KdV_adaptive_tanh.py --init_tanh_a 3.0', shell=True, cwd=cwd)
subprocess.call('python3 KdV_adaptive_tanh.py --init_tanh_a 4.0', shell=True, cwd=cwd)
"""
print('### Tanh ###')
subprocess.call('python3 KdV_tanh.py', shell=True, cwd=cwd)
"""
